...
| Menu logo | `logo.png` | fit into 640 × 260, **aspect kept** | up to **640 × 260** | The main-menu title. Optional — without it a stylized wordmark is drawn. Usually lives in `art/default/` (it shows for every theme), but a theme can override it. Transparent background; the whole logo gently wobbles in place. |
